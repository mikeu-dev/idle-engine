...
func TestCalculateMaxLevelsAffordable(t *testing.T) {
	// Contoh: Base Cost = 10, multiplier = 1.5, currentLevel = 0
	// Level 1: cost = 10 (total 10)
	// Level 2: cost = 15 (total 25)
	// Level 3: cost = 22.5 (total 47.5)

	// Uji saldo pas-pasan untuk 2 level (25.0)
	...
	// Uji saldo sedikit di bawah 25.0 (24.9)
	...
	// Uji saldo di bawah base cost (3.0)
